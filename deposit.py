...
class Deposit(QWidget):
    ...
    def set_ui(self):
        ...
        f=QFormLayout()
        self.lbl=QLabel("Deposit Your Money")
        self.lbl.setObjectName("head")

        self.lbl1=QLabel("Enter Amount For Deposit:")
        self.txt1=QDoubleSpinBox()
        self.txt1.setMaximum(999999999)
        self.btn1=QPushButton("Deposit")
        self.btn1.clicked.connect(self.deposit_cash)
    ...
    def deposit_cash(self):
        ...
        if amt<1000:
            QMessageBox.critical(self,"Not Enough","Amount should be more than 1000.")
            return
        ...
        try:
            ...
            QMessageBox.information(self,"Success",f"Your amount Rs.{amt} has been deposited.")
